...
<nav class="navbar navbar-expand-lg navbar-light bg-light nav-h">
  <div class="container-fluid ml-60 mr-60">
    ...
    <div class="d-flex justify-content-center">
      <ul class="nav nav-pills custom-pill-nav" id="pills-tab" role="tablist">
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
      <button class="btn btn-primary rounded-button" type="button"> <i class="fa fa-shopping-cart" aria-hidden="true"></i></button>
    </div>
  </div>
</nav>
